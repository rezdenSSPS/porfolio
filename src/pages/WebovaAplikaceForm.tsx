...
import { Send, Globe, ArrowLeft, Check } from "lucide-react";
import { useState } from "react";
import { Link } from "react-router-dom";
import { Navbar } from "@/components/Navbar";
import { Footer } from "@/components/Footer";

export function WebovaAplikaceForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...formData,
          subject: `Poptávka: Webová Aplikace - ${formData.websiteType}`,
        }),
      });
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto">
              Vyplňte formulář a získejte nezávaznou cenovou nabídku na váš nový web.
            </p>
          </motion.div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-secondary/50 border-2 border-border rounded-lg text-foreground placeholder-muted-foreground focus:outline-none focus:border-accent transition-colors"
                    placeholder="Např. za 2 měsíce, do konce roku..."
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Popište váš projekt, cílovou skupinu, reference..."
                    required
                  />
                </div>
